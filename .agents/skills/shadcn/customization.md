...
bunx --bun shadcn@latest apply --preset nova

# Preserve existing components instead.
bunx --bun shadcn@latest init --preset nova --force --no-reinstall

# Use a custom theme URL.
bunx --bun shadcn@latest apply --preset "https://ui.shadcn.com/init?base=radix&style=nova&theme=blue&..."
```
...
When `tailwindVersion` is `"v3"` (check via `bunx --bun shadcn@latest info`), register in `tailwind.config.js` instead:
