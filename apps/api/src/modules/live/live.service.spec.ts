    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        LiveService,
        {
          ...
          useValue: {
            findActive: vi.fn<any>(),
            findDeletedFromActive: vi.fn<any>(),
            findUpcoming: vi.fn<any>(),
            findDeletedFromUpcoming: vi.fn<any>(),
            findEnded: vi.fn<any>(),
            findDeletedFromEnded: vi.fn<any>(),
            findSessionById: vi.fn<any>(),
            findSessionPublicById: vi.fn<any>(),
            updateSessionStatus: vi.fn<any>(),
            findChannels: vi.fn<any>(),
            findChannelBySlug: vi.fn<any>(),
            findChannelById: vi.fn<any>(),
            createChannel: vi.fn<any>(),
            updateChannel: vi.fn<any>(),
            createSession: vi.fn<any>(),
            updateSession: vi.fn<any>(),
            listChannels: vi.fn<any>(),
