...
| `localized-account-flow.e2e.ts` | canonical navigation, anonymous routes, sign-out success/failure, cookie consent, Arabic/RTL, and mobile settings/library controls      | #719                          |
...
| `workspace.e2e.ts`              | signed-out search, listener/admin capability boundaries, mobile keyboard/RTL behavior, and theme preference                             | #717 / #718 / #719            |
