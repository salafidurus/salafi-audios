...
describe("SegmentedControl", () => {
  it("renders all options", () => {
    render(
      <SegmentedControl options={OPTIONS} value="system" onChange={vi.fn()} />,
    );
  ...
  it("marks the selected option as pressed", () => {
    render(
      <SegmentedControl options={OPTIONS} value="light" onChange={vi.fn()} />,
    );
  ...
  it("calls onChange with the new value when a segment is clicked", () => {
    ...
    render(
      <SegmentedControl options={OPTIONS} value="system" onChange={handleChange} />,
    );
