...
export const APPROVED_NATIVE_BRIDGES: readonly ApprovedNativeBridge[] = [
  ...
  },
  {
    ...
    reason:
      "Marquee text scrolling requires Reanimated translateX animation and layout measurement.",
  },
  {
    file: "src/shared/components/AccentGradientFill/AccentGradientFill.tsx",
    reason: "Accent gradient fill requires SVG Defs linear and radial gradient primitives.",
  },
  {
    file: "src/shared/components/Button/Button.ios.tsx",
    reason:
      "Native button implementation hosts ActivityIndicator loading indicator inside SwiftUI button wrapper.",
  },
  {
    file: "src/shared/components/Button/Button.android.tsx",
    reason:
      "Native button implementation hosts ActivityIndicator loading indicator inside Compose button wrapper.",
  },
  {
