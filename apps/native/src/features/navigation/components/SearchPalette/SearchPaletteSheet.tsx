...
/** Provides the universal fallback implementation for the native search palette sheet. */
...
/** Uses the universal Expo UI sheet on platforms without a specialized implementation. */
