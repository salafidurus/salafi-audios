...
describe('QueueManager', () => {
  ...
  const mockTracks: Track[] = [
    { id: 't1', title: 'Track 1', artist: 'Scholar 1', url: 'https://test.mp3', durationSeconds: 600 },
    { id: 't2', title: 'Track 2', artist: 'Scholar 1', url: 'https://test.mp3', durationSeconds: 1200 },
    { id: 't3', title: 'Track 3', artist: 'Scholar 2', url: 'https://test.mp3', durationSeconds: 1800 },
  ];
