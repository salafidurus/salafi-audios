...
- `packages/util-ingest/content/audio/<scholar-slug>/<lecture-slug>.mp3`

Optional nested layout (when using explicit `audioAssets[].file`):

- `packages/util-ingest/content/audio/<scholar-slug>/<series-slug>/<file>.mp3`

Examples:

- `packages/util-ingest/content/audio/abdul-aziz-ibn-baz/kitab-al-iman-lesson-01.mp3`
- `packages/util-ingest/content/audio/salih-al-fawzan/muhadarah-on-fear-of-allah.mp3`
...
```bash
ffmpeg -f lavfi -i anullsrc=r=44100:cl=mono -t 5 -q:a 9 -acodec libmp3lame packages/util-ingest/content/audio/abdul-aziz-ibn-baz/kitab-al-iman-lesson-01.mp3
```
