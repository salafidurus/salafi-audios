...
- Build: `pnpm --filter core-env build`
- Lint: `pnpm --filter core-env lint`
- Typecheck: `pnpm --filter core-env typecheck`
- Test: `pnpm --filter core-env test`

## Single-test commands

- Jest file: `pnpm --filter core-env test -- src/path/to/file.spec.ts`
- Jest by name: `pnpm --filter core-env test -- src/path/to/file.spec.ts -t "parses env"`
