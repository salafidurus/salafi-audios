...
import { formatDuration } from "@sd/shared";

type SearchResultItemProps = SearchCatalogItemDto & { group: string };
...
export function SearchResultItem({ group, ...item }: SearchResultItemProps) {
