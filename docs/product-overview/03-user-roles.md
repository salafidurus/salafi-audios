...
This document outlines the primary roles within Salafi Durus and explains why these distinctions matter.
...
- Retain and revisit knowledge over time
...
- Maintain a personal listening history

These capabilities are focused entirely on consumption and learning.
...
- Interact socially through comments or public feedback

This limitation is intentional. It preserves clarity and avoids the risks associated with open user-generated content.
...
Administrators hold the highest level of trust and authority within the system.
...
- Perform bulk operations on lectures and series
- Moderate content quickly and decisively
- Access administrative tools from both web and mobile interfaces

Administrative tools are designed for speed, clarity, and reliability rather than complexity.
...
The system is designed to support correction and responsiveness, not to encourage unchecked changes.
...
Scholar / Content Editors represent a scoped administrative role.
...
- Edit metadata and correct mistakes
...
- Override core moderation rules

These limitations ensure that distributed management does not compromise consistency or trust.
...
Blurring these roles would increase risk, reduce clarity, and undermine confidence in the platform.
...
Any expansion of roles should be approached with caution and aligned with the core philosophy of Salafi Durus.

---

## Closing Note

Roles in Salafi Durus are not about power; they are about responsibility.

By clearly defining who can do what—and why—the platform maintains a stable foundation for growth, moderation, and long-term preservation of knowledge.
